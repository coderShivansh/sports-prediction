        ...
        <Main>
            <header>
                ...
                <div className={`dropdown_menu ${isOpen ? 'open' : ''}`}>
                        <ul>
                            <li><Link to='/' onClick={closeDropdown}>BasketBall</Link></li>
                            <li><Link to='/cricket' onClick={closeDropdown}>Cricket</Link></li>
                            <li><Link to='/ruby' onClick={closeDropdown}>Ruby</Link></li>
                            <li><Link to='/f1' onClick={closeDropdown}>F1</Link></li>
                            <li><Link to='/dhu' onClick={closeDropdown}>DHU</Link></li>
                            <li><Link to='/bigbash' onClick={closeDropdown}>BigBash</Link></li>
